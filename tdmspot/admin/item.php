  ...
  //creation du formulaire de tris
	...
	$pagenav = '';
		...
		if ($numrows>0) {
			...
			echo '<tr>';
			echo '<th align="center" width="10%">'._AM_SPOT_VISIBLE.'</th>';
			echo '<th align="center" width="20%">'._AM_SPOT_INDATE.'</th>';
			echo '<th align="center" width="20%">'._AM_SPOT_CATEGORY.'</th>';
			echo '<th align="center" width="40%">'._AM_SPOT_TITLE.'</th>';
			...
			$file = XOOPS_URL. "/modules/".$xoopsModule->dirname()."/images/blank.png";
				...
				echo '<td align="center" width="10%">'.$indate.'</td>';
				echo '<td align="center" width="20%">'.$cat_title.'</td>';
				echo '<td align="center" width="50%">'.$title.'</td>';
