...
$xoopsOption['template_main'] = 'spot_viewitem.tpl';
    ...
    default:
        ...
        foreach (array_keys($item_arr) as $i) {
            ...
            if ($pos != 0) {
                ...
                $xoopsTpl->assign("prev_page", "<span style='text-decoration: underline;'>&laquo;</span> <span style='font-weight: bold;'>" . _MD_TDMSPOT_ITEMPREV . "</span><br /><br />" . $nav_date[$pos - 1] . " - <a href='" . $prev_link . "'>" . $nav_title[$pos - 1] . "</a>");
            }
            if ($pos != $numrows) {
                $next_link = tdmspot_seo_genUrl($xoopsModuleConfig['tdmspot_seo_item'], $nav_ids[$pos + 1], $nav_title[$pos + 1]);
                $xoopsTpl->assign("next_page", "&nbsp;&nbsp;<span style='font-weight: bold;'>" . _MD_TDMSPOT_ITEMNEXT . "</span> <span style='text-decoration: underline;'>&raquo;</span><br /><br />" . $nav_date[$pos + 1] . " - <a href='" . $next_link . "'>" . $nav_title[$pos + 1] . "</a>");
            }
            //
